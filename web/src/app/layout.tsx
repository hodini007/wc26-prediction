...
export const metadata: Metadata = {
  ...
  description: "Advanced Machine Learning prediction system and Monte Carlo simulator for the FIFA World Cup 2026.",
};
      ...
      <body className="min-h-full flex flex-col bg-[#0a0e1a] text-[#f9fafb]">
        ...
        <footer className="border-t border-[#1f2937] bg-[#0a0e1a] py-6">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center text-xs text-gray-500">
            ...
            <p className="mt-1">All rights reserved. Simulated with 100,000 Monte Carlo iterations.</p>
          </div>
        </footer>
      </body>
    </html>
